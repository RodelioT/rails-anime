...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { episode_count: @anime.episode_count, image_url: @anime.image_url, mal_id: @anime.mal_id, name: @anime.name, rating: @anime.rating } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { episode_count: @anime.episode_count, image_url: @anime.image_url, mal_id: @anime.mal_id, name: @anime.name, rating: @anime.rating } }
